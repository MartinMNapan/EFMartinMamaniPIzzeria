package pe.idat.edu.EFMartinMamaniPizzeria.controller;
...
import pe.idat.edu.EFMartinMamaniPizzeria.service.PizzeriaService;

@Controller
@RequestMapping(path = "api/pizzeria/v1")
